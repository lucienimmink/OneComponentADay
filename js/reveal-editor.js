    ...
    function setUpControls(este) {
      ...
      $(".run").click(function() {
        var js = parseJavascript(),
          ...
          html = parseHtml(),
          t =
            "<script> var div = parent.document.body.getElementsByClassName('console'); var console = {panel: div,log: function(m){this.panel[0].innerHTML = this.panel[0].innerHTML + '<p>' + m + '</p>';} }; </script>",
